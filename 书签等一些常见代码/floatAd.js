(function($){
	$.fn.floatAd = function(options){
		var defaults = {
			imgSrc : "images/cc.png", //漂浮图片路径
			url : "http://aicwebw04/2.html", //图片点击跳转页
		...
		var html = "<div id='float_ad' style='position:absolute;left:0px;top:0px;z-index:1000000;cleat:both;'>";
            html += "  <a href='http://aicwebw04/2.html' " + _target + "><img src='" + options.imgSrc + "' border='0' class='float_ad_img'/></a> <a href='javascript:;' id='close_float_ad' style='' title='点击关闭'>x</a>";
            html += "</div>";
