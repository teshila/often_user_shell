...
@Component
public class GetMonthLineInfoByTencent {
	private static Logger logger = Logger.getLogger(GetMonthLineInfoByTencent.class);
	...
	//http://data.gtimg.cn/flashdata/hushen/latest/monthly/sz000983.js?maxage=43201
	private static final String TENCENT_URL = "http://data.gtimg.cn/flashdata/hushen/latest/monthly/STOCK.js?maxage=43201";
