<template>
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">短线算法(交日易收盘15点得出当前列表，共 {{totalCount}} 条)</h3>
		</div>
...
//https://blog.csdn.net/moniteryao/article/details/77893566
//https://blog.csdn.net/ganquanzhong/article/details/80320748


//set https://www.jianshu.com/p/6542c68401e6
