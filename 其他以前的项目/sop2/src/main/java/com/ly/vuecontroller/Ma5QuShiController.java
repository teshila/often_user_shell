...
public class Ma5QuShiController {
	...
	public Page<Ma5VolQuShi> getInfo(String pageNum,String pageSize){
		int pageNo = 0;
		int row = 10;
		...
		Page<Ma5VolQuShi> pages = new Page<Ma5VolQuShi>();
	...
	public Page<Ma5VolQuShi> findBlockDay(String code) {
