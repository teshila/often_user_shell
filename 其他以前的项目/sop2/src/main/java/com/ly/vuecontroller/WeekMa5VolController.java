...
public class WeekMa5VolController {
	...
	public Page<WeekMa5VolQuShi> getInfo(String pageNum,String pageSize){
		int pageNo = 0;
		int row = 10;
		...
		Page<WeekMa5VolQuShi> pages = new Page<WeekMa5VolQuShi>();
	...
	public Page<WeekMa5VolQuShi> findBlockDay(String code) {
