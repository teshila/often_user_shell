...
public class WeekMa5VolBigMa10VolController {
	...
	public Page<WeekMa5VolBigMa10Vol> getInfo(String pageNum,String pageSize){
		int pageNo = 0;
		int row = 10;
		...
		Page<WeekMa5VolBigMa10Vol> pages = new Page<WeekMa5VolBigMa10Vol>();
	...
	public Page<WeekMa5VolBigMa10Vol> findBlockDay(String code) {
