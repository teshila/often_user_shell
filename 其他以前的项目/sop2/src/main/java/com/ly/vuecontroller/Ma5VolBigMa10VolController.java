...
public class Ma5VolBigMa10VolController {
	...
	public Page<Ma5VolBigMa10Vol> getInfo(String pageNum,String pageSize){
		int pageNo = 0;
		int row = 10;
		...
		Page<Ma5VolBigMa10Vol> pages = new Page<Ma5VolBigMa10Vol>();
	...
	public Page<Ma5VolBigMa10Vol> findBlockDay(String code) {
