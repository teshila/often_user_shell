...
//短线算法
@Component
public class Day_Line_Ma10_Da_Yu_Ma20Computing {
	...
	public void getStockInfo() {
		...
		List<Stock_Ma10_Da_Yu_Ma20> entitys =  null;
		stock_Ma10_DaYu_Ma20Dao.truncateTable(Stock_Ma10_Da_Yu_Ma20.class);
		Stock_Ma10_Da_Yu_Ma20 stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<Stock_Ma10_Da_Yu_Ma20>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=3){
					...
					if(day1IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa5>0&&day1Ma10IsBigDay2Ma10>=0){
						...
						stock_Shou_Yang_Day_One_Day = new Stock_Ma10_Da_Yu_Ma20();
