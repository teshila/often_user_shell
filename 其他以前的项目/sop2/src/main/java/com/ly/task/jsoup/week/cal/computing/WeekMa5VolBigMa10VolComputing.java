...
import com.ly.pojo.Ma5VolBigMa10Vol;
import com.ly.pojo.Stock;
import com.ly.pojo.Stock_K_line_Day_DataList;
import com.ly.pojo.Stock_K_line_Week_DataList;
import com.ly.pojo.WeekMa5VolBigMa10Vol;

//短线算法
@Component
public class WeekMa5VolBigMa10VolComputing {
	...
	@Autowired
	private Week_Ma5VolBigMa10Dao stock_Ma10_DaYu_Ma20Dao;
	...
	public void getStockInfo() {
		...
		List<WeekMa5VolBigMa10Vol> entitys =  null;
		stock_Ma10_DaYu_Ma20Dao.truncateTable(WeekMa5VolBigMa10Vol.class);
		WeekMa5VolBigMa10Vol stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<WeekMa5VolBigMa10Vol>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=3){
					...
					if(day1IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa5>0&&day1Ma10IsBigDay2Ma10>=0&&ma5VolBigMa10>=0&&ma5VolIsZhang>=0){
						...
						stock_Shou_Yang_Day_One_Day = new WeekMa5VolBigMa10Vol();
