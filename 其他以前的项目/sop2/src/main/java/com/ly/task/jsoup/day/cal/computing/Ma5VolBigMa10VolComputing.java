...
//短线算法
@Component
public class Ma5VolBigMa10VolComputing {
	...
	public void getStockInfo() {
		...
		List<Ma5VolBigMa10Vol> entitys =  null;
		stock_Ma10_DaYu_Ma20Dao.truncateTable(Ma5VolBigMa10Vol.class);
		Ma5VolBigMa10Vol stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<Ma5VolBigMa10Vol>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=3){
					...
					if(day1IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa5>0&&day1Ma10IsBigDay2Ma10>=0&&ma5VolBigMa10>=0&&ma5VolIsZhang>=0){
						...
						stock_Shou_Yang_Day_One_Day = new Ma5VolBigMa10Vol();
