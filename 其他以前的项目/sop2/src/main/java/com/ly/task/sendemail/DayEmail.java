...
public class DayEmail {
	...
	public void taskSendDayWeek() throws Exception {
		...
		List<Week_Line_Ma10_Da_Yu_Ma20> listDay = onlyWeekShouYangDao.find("from Week_Line_Ma10_Da_Yu_Ma20  "+SystemConfig.myAppendStrWeek);
	...
	public void taskDayMa10BigMa20() throws Exception {
		List<Stock_Ma10_Da_Yu_Ma20> listDay = stock_Ma10_DaYu_Ma20Dao.find("from Stock_Ma10_Da_Yu_Ma20 "+SystemConfig.myAppendStrForShiRi);
