...
@Component
public class Stock_Shou_Yang_Day_And_Week_Shou_Yang_Computing {
	
	private static Logger calday = Logger.getLogger("dayandweeekup");
	...
	public void getStockInfo() {
		...
		List<Stock_Shou_Yang_Day_And_Week_Shou_Yang> entitys =  null;
		stock_Shou_Yang_One_DayDao.truncateTable(Stock_Shou_Yang_Day_And_Week_Shou_Yang.class);
		Stock_Shou_Yang_Day_And_Week_Shou_Yang stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<Stock_Shou_Yang_Day_And_Week_Shou_Yang>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				//	if(day1IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa5>0&&day2IsZhang>0&&day2IsBigThanMa5>0&&day2Ma5IsBigThanyesterMa5>0){
					if(day1IsZhang>0&&day2IsZhang>0&&dayIsZhang>0){
						...
						stock_Shou_Yang_Day_One_Day = new Stock_Shou_Yang_Day_And_Week_Shou_Yang();
