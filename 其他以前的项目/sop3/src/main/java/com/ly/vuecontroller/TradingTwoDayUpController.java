...
public class TradingTwoDayUpController {
	...
	public Page<Tradding_Stock_Yang_Of_Two_Day_Up> findBlockDay(String code) {
		...
		Page<Tradding_Stock_Yang_Of_Two_Day_Up> pages = new Page<Tradding_Stock_Yang_Of_Two_Day_Up>();
		pages.setTotalCount((int)total);
		pages.setPageList(list);
		return pages;
	}
