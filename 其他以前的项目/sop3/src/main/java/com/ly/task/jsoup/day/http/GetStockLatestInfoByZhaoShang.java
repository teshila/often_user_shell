...
@Component
public class GetStockLatestInfoByZhaoShang {

	private static Logger logger = Logger.getLogger(GetStockLatestInfoByZhaoShang.class);
	
	@Autowired
	private ZhaoShangHttp zhaoShangHttp;
	
	public List getBatchList(List<Stock> sts){
		Date date = new Date();
