...
@Component
public class GetWeekLineInfoByPingAnHttp {
	private static Logger logger = Logger.getLogger(GetWeekLineInfoByPingAnHttp.class);
	...
	public static final String WEEK_URL= "https://m.stock.pingan.com/h5quote/quote/getDayDataBigInt?random=RANDOM&thirdAccount=&rdm=&timestamp=&tokenId=&signature=&key=&chnl=&requestId=&stockCode=STOCKCODE&codeType=CODETYPE&period=week&day=50"; //最近30交易日
	...
	public static final String MONTH_URL= "https://m.stock.pingan.com/h5quote/quote/getDayDataBigInt?random=RANDOM&thirdAccount=&rdm=&timestamp=&tokenId=&signature=&key=&chnl=&requestId=&stockCode=STOCKCODE&codeType=CODETYPE&period=month&day=50"; //最近30交易日
