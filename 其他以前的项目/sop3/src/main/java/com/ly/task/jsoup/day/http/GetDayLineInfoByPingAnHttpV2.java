...
@Component
public class GetDayLineInfoByPingAnHttpV2 {
	private static Logger logger = Logger.getLogger(GetDayLineInfoByPingAnHttpV2.class);
	...
	public static final String DAY_URL= "https://quote.stock.pingan.com/restapi/nodeserver/quote/kLineDate?_=RANDOM";
	...
	public List<Map<String,String>> getDayLineInfo(String code){
		...
		try {
			...
			if (result != null) {
				...
				JSONArray arrays = (JSONArray)keys.get("subBeans") ;
