			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=20){
					...
					for(int arr =0;arr<15;arr++){
						...
						Stock_K_line_Day_DataList day3 = datas.get(arr+1);
						...
						double day1Ma5IsBigThanyesterMa10 = day1Ma5 - day2Ma5;
						calday.debug(" ===>" + sts.getCode() + "  ==> "+ sts.getName());
						calday.debug(day1IsZhang + " =====  " + day2IsZhang  +"====>"+ day3IsZhang);
					
					if(day1IsZhang>0&&day2IsZhang>0&&day3IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa10>0){
