...
public class WeekMa5VolBigMa10VolComputing {
	...
	public void getStockInfo() {
		...
		List<Stock_Week_Ma5Vol_Big_Week_Ma10Vol> entitys =  null;
		stock_Ma10_DaYu_Ma20Dao.truncateTable(Stock_Week_Ma5Vol_Big_Week_Ma10Vol.class);
		Stock_Week_Ma5Vol_Big_Week_Ma10Vol stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<Stock_Week_Ma5Vol_Big_Week_Ma10Vol>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=20){
					...
					if(day1IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa5>0&&day1Ma10IsBigDay2Ma10>=0&&ma5VolBigMa10>=0&&ma5VolIsZhang>=0){
						...
						stock_Shou_Yang_Day_One_Day = new Stock_Week_Ma5Vol_Big_Week_Ma10Vol();
