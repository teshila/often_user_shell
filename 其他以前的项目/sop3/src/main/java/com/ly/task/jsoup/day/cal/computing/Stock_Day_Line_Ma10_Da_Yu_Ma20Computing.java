...
//短线算法
@Component
public class Stock_Day_Line_Ma10_Da_Yu_Ma20Computing {
	...
	public void getStockInfo() {
		...
		List<Stock_Day_Ma10_Big_Ma20> entitys =  null;
		stock_Ma10_DaYu_Ma20Dao.truncateTable(Stock_Day_Ma10_Big_Ma20.class);
		Stock_Day_Ma10_Big_Ma20 stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<Stock_Day_Ma10_Big_Ma20>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=20){
					...
					for(int arr =0;arr<15;arr++){
						...
						if(day1IsZhang>0&&day1IsBigThanMa5>0&&day1Ma5IsBigThanyesterMa5>0&&day1Ma10IsBigDay2Ma10>=0){
						
						
						calday.info(day1IsZhang + " =====  " + day2IsZhang  +"====>"+ day3IsZhang);
						stock_Shou_Yang_Day_One_Day = new Stock_Day_Ma10_Big_Ma20();
